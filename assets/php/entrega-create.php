    ...
    <div class="container mt-4">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white">
                <h4 class="mb-0 fw-bold">📦 Nova Entrega
                ...
                <form action="acoes.php" method="POST">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label class="form-label fw-semibold">ID da Entrega</label>
                            <input type="text" name="id" class="form-control" placeholder="Ex: ABC123XYZ" required>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="form-label fw-semibold">Dimensões (cm X,Y,Z)</label>
                            <input type="text" name="dimensoes_cm_xyz" class="form-control"
                                placeholder="Ex: 72, 172, 60">
                        </div>
                        <div class="col-md-12 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="motorista_cpf" class="form-select">
                                ...
                                <?php foreach ($motoristas as $m): ?>
                                    <option value="<?= htmlspecialchars($m['cpf']) ?>"><?= htmlspecialchars($m['nome']) ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="veiculo_id" class="form-select">
                                ...
                                <?php foreach ($veiculos as $v): ?>
                                    <option value="<?= $v['id'] ?>"><?= htmlspecialchars($v['modelo']) ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="rota_id" class="form-select">
                                ...
                                <?php foreach ($rotas as $rt): ?>
                                    <option value="<?= $rt['id'] ?>"><?= htmlspecialchars($rt['origem']) ?> →
                                        <?= htmlspecialchars($rt['destino']) ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    ...
                    <button type="submit" name="create_entrega" class="btn btn-dark">💾 Salvar</button>
                </form>
            </div>
        </div>
    </div>
