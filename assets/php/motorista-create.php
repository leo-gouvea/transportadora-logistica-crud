    ...
    <div class="container mt-4">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white">
                <h4 class="mb-0 fw-bold">👤 Cadastrar Motorista
                ...
                <form action="acoes.php" method="POST">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="idade" class="form-control" min="18" max="99">
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="veiculo_id" class="form-select">
                                ...
                                <?php foreach ($veiculos as $v): ?>
                                    <option value="<?= $v['id'] ?>"><?= htmlspecialchars($v['modelo']) ?>
                                        (<?= $v['categoria'] ?>)</option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    ...
                    <button type="submit" name="create_motorista" class="btn btn-dark">💾 Salvar</button>
                </form>
            </div>
        </div>
    </div>
